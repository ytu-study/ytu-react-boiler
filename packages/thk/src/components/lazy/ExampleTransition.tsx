  ...
  return (
    <div className="w-[1000px] py-[20px] text-center">
      <p className="flex justify-center items-center">
        <button
          className="p-[5px] bg-slate-100 border-slate-400 border-[1px] rounded-[4px]"
          onClick={() => {
            setNum(i => i - 1);
        ...
        <span className="mx-[10px] py-[5px] px-[20px] border-slate-400 border-[1px] rounded-[4px]">{num}</span>
        <button
          className="p-[5px] bg-slate-100 border-slate-400 border-[1px] rounded-[4px]"
          onClick={() => {
            setNum(i => i + 1);
